...
MATH1_KNOWLEDGE_MAP_ALIAS: Dict[str, str] = {
    "函数的性质与图形": "01.01 第一节 函数",
    "函数极限": "01.02 第二节 函数极限",
    "数列极限": "01.03 第三节 数列极限",
    "无穷小与无穷大的比较": "01.02 第二节 函数极限",
    "连续性与间断点分类": "01.04 第四节 函数的连续性",
    "导数定义与几何意义": "02.01 第一节 导数与微分的相关概念",
    "求导法则与高阶导数": "02.02 第二节 导数与微分的计算",
    "微分中值定理": "03.02 第二节 拉格朗日中值定理",
    "洛必达法则与泰勒展开求极限": "03.04 第四节 泰勒公式",
    "函数单调性、极值与最值": "04.01 第一节 单调性与极值",
    "曲线凹凸性、拐点与渐近线": "04.02 第二节 凹凸性与拐点",
    "不定积分计算": "05.02 第二节 不定积分的计算",
    "定积分的性质与计算": "06.01 第一节 定积分的计算",
    "反常积分的判敛与计算": "06.04 第四节 反常积分",
    "定积分的应用": "06.05 第五节 定积分的应用",
    "多元函数极限与连续": "08.01 第一节 多元函数微分学的基本概念",
    "偏导数与全微分": "08.02 第二节 复合函数的偏导数和全微分",
    "复合函数与隐函数求导": "08.03 第三节 隐函数微分法",
    "多元函数极值与条件极值": "08.04 第四节 极值与最值",
    "二重积分": "10.02 第二节 二重积分的计算",
    "三重积分": "13.01 第一节 三重积分",
    "曲线积分": "14.01 第一节 第二型曲线积分",
    "曲面积分": "14.02 第二节 第二型曲面积分",
    "向量运算": "11.01 第一节 向量代数",
    "平面方程与直线方程": "11.02 第二节 平面方程与直线方程",
    "曲面方程与空间曲线": "11.03 第三节 曲面方程",
    "常数项级数的判敛": "12.01 第一节 常数项级数",
    "幂级数的收敛域与求和": "12.02 第二节 幂级数",
    "函数展开为幂级数": "12.02 第二节 幂级数",
    "傅里叶级数": "12.03 第三节 傅里叶级数",
    "一阶微分方程": "09.02 第二节 一阶微分方程",
    "高阶线性微分方程": "09.04 第四节 高阶线性微分方程",
    "微分方程的应用": "09.01 第一节 微分方程的基本概念",
    "行列式的性质与计算": "01.01 第一节 行列式的概念与性质",
    "按行列展开": "01.01 第一节 行列式的概念与性质",
    "克拉默法则": "01.02 第二节 克拉默法则",
    "矩阵运算与性质": "02.01 第一节 矩阵的概念与运算",
    "逆矩阵": "02.03 第三节 可逆矩阵",
    "初等变换与初等矩阵": "02.05 第五节 初等矩阵",
    "矩阵的秩": "02.04 第四节 矩阵的秩",
    "线性相关与线性无关": "03.02 第二节 向量组的线性相关性和线性表示",
    "向量组的秩": "03.02 第二节 向量组的线性相关性和线性表示",

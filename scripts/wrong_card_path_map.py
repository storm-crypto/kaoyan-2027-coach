...
WRONG_CARD_PATH_MAP: Dict[str, Dict[str, str]] = {
    "数学一": {
        ...
        "积分变限函数的求导问题": "高等数学/06 第六章 定积分及其应用/02 第二节 积分变限函数的求导问题",
        ...
        "方向导数与梯度": "高等数学/08 第八章 多元函数微分学/05 第五节 方向导数与梯度",
        "二重积分": "高等数学/10 第十章 二重积分/02 第二节 二重积分的计算",
        "三重积分": "高等数学/13 第十三章 三重积分及第一型曲线、曲面积分/01 第一节 三重积分",
        "第一型曲线积分": "高等数学/13 第十三章 三重积分及第一型曲线、曲面积分/02 第二节 第一型曲线积分",
        "第一型曲面积分": "高等数学/13 第十三章 三重积分及第一型曲线、曲面积分/03 第三节 第一型曲面积分",
        "曲线积分": "高等数学/14 第十四章 第二型曲线、曲面积分/01 第一节 第二型曲线积分",
        "曲面积分": "高等数学/14 第十四章 第二型曲线、曲面积分/02 第二节 第二型曲面积分",
        "第二型曲线、曲面积分的奇偶对称性": "高等数学/14 第十四章 第二型曲线、曲面积分/03 第三节 第二型曲线、曲面积分的奇偶对称性",
        "场论简介": "高等数学/14 第十四章 第二型曲线、曲面积分/04 第四节 场论简介",
